...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  final List<_ChatMessage> _messages = [
    _ChatMessage(role: _ChatRole.bot, text: 'Hi! I am KaamBot. Ask me about the KaamSetu app or how to use it.'),
  ];
  ...
  String _createResponse(String query) {
    ...
    if (normalized.contains('wallet') || normalized.contains('payment') || normalized.contains('money')) {
    ...
    if (normalized.contains('support') || normalized.contains('help') || normalized.contains('customer')) {
    ...
    if (normalized.contains('profile') || normalized.contains('availability') || normalized.contains('rating')) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: KsText(t('chatbot'), style: GoogleFonts.notoSans(fontSize: 18, fontWeight: FontWeight.w700)),
      ),
      body: SafeArea(
        child: Column(
          children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.notoSans(color: AppTheme.mutedForeground),
                        filled: true,
