...
final List<AppUser> demoHouseholds = [
  AppUser(
    ...
    role: 'household', language: 'en', onboarded: true, kycStatus: 'NONE',
  ...
  AppUser(
    ...
    role: 'household', language: 'gu', onboarded: true, kycStatus: 'NONE',
  ...
  AppUser(
    ...
    role: 'household', language: 'mr', onboarded: true, kycStatus: 'NONE',
  ...
  AppUser(
    ...
    role: 'household', language: 'hi', onboarded: true, kycStatus: 'NONE',
