...
class _JobCardWidgetState extends State<JobCardWidget> {
  ...
  Future<void> _apply() async {
    if (!context.read<AppProvider>().isWorkerProfileComplete) return;
    setState(() {
      _loading = true;
    });
    await Future.delayed(const Duration(milliseconds: 600));
    if (mounted) {
      final applied = context.read<AppProvider>().expressInterest(
        widget.feedJob.job.id,
      );
      setState(() {
        _loading = false;
        _expanded = false;
        if (applied) _interest = 'interested';
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isProfileComplete = context
        .watch<AppProvider>()
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: _isTop ? AppTheme.primary.withOpacity(0.4) : AppTheme.border,
          width: _isTop ? 2 : 1,
        ),
      ),
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 4),
                  KsText(
                    '${job.startTime} · ${job.durationHours}h',
                    style: GoogleFonts.notoSans(
                      fontSize: 12,
                      color: AppTheme.mutedForeground,
                      fontWeight: FontWeight.w500,
          ...
          // Expand form
          if (_expanded && _interest == null && isProfileComplete) ...[
              ...
              child: Column(
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'I have done this work for 5 years.',
          ...
          else if (_expanded && isProfileComplete)
            Row(
              children: [
                Expanded(
                  child: SizedBox(
