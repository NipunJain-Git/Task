...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void _save() {
    ...
    Future.delayed(const Duration(milliseconds: 600), () {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: KsText('Profile updated successfully')),
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: KsText(
          tr(lang, 'Edit Profile') == 'Edit Profile'
              ? 'Edit Profile'
              : tr(lang, 'Edit Profile'),
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              labelText: tr(lang, 'Full Name') == 'Full Name'
                  ? 'Full Name'
                  : tr(lang, 'Full Name'),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: tr(lang, 'Search Radius (km)') == 'Search Radius (km)'
                  ? 'Search Radius (km)'
                  : tr(lang, 'Search Radius (km)'),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
              ),
            ),
